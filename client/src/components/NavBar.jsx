      ...
      className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
        ...
        <div className='flex items-center gap-6 relative'>
            <div className='relative'>
                ...
                className='flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-b-full text-md hover:bg-gray-200 transition'>
                    <BsCoin size={20}/>
                    {userData?.credits || 0}
                </button>

                {showCreditPopup && (
                    <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl bord border-gray-200 rounded p-5 z-50'> 
            ...
            <div className='relative'>
                ...
                className='w-9 h-9 bg-black text-white rounded-b-full flex items-center justify-center font-semibold'>

        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative justify-between'>
          <div>
            ...
            <textarea
              ...
              value={answer}
              className="w-full h-64 bg-gray-100 p-4 sm:p-6 rounded-2xl resize-none outline-none border border-gray-200 focus:ring-2 focus:ring-emerald-500 transition text-gray-800"
            />
          </div>

          {/* Render Mic & Submit Button when there is NO feedback yet */}
          {!feedback ? (
            ...
            /* Render Feedback Box & Next Question Button after feedback is received */
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
